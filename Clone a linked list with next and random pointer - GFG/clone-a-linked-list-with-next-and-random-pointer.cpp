...
class Solution
{
    ...
    Node *copyList(Node *head)
    {
        ...
        Node *curr = head;
        Node *temp;
        //duplicating the list in b/w
        while(curr){
            temp = curr->next;//save next of current
            //new node
        ...
        //linking of random pointers
        curr = head;
        while(curr){
            if(curr->next){
                curr->next->arb = curr->arb?curr->arb->next:curr->arb;
            }
            //move curr to next node of original list
            curr = curr->next?curr->next->next:curr->next;
        }
        
        //restoring original connections
        Node *original = head, *copy = head->next;
        temp = copy;//save head of cloned list
